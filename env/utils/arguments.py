...
def get_rl_args():
    ...
    parser.add_argument('--rom_path',
                        default='../env/roms/jericho-game-suite/{}')
    ...
    #
    # parser.add_argument('--count_bonus', action='store_true')
    ...
    # - conv encoder
    # parser.add_argument('--query_kernel', default=3, type=float)
    # parser.add_argument('--context_kernel', default=7, type=float)
    ...
    parser.add_argument('--normalize_rewards', default='original',
    ...
    # ablative study
    # parser.add_argument('--no_self_att', action='store_true')
    # parser.add_argument('--no_final_gru', action='store_true')
    parser.add_argument('--history_window', default=1, type=int)
    parser.add_argument('--recency_retrieval', action='store_true')
